...
public class Cards
{
	...
	public void shuffle_deck()
	{
		...
		try
		{
			...
			Log.e("Shuffle Deck","Total cards : "+ deck.size());
			String toprint = "";
			for(int i=0; i<deck.size(); i++)
			{
				toprint += deck.get(i)+ ",";
			}
			Log.e("Shuffle Deck", "Values are :"+toprint);
		}
		catch(Exception ex)
		{
			Log.e("Shuffle Deck", ex.toString());
		}
	}
	...
	public void shuffle_open_cards()
	{
		...
		try
		{
			...
			Log.e("Shuffle open","Total cards : "+ open_cards.size());
			String toprint = "";
			for(int i=0; i<open_cards.size(); i++)
			{
				toprint += open_cards.get(i)+ ",";
			}
			Log.e("Shuffle open", "Values are :"+toprint);
		}
		catch(Exception ex)
		{
			Log.e("Shuffle open", ex.toString());
		}
    ...
    public void set_open_card(int card)
    {
        try
        {
            open_cards.addFirst(card);
        }
        catch(Exception ex)
        {
            Log.e("Card",ex.toString());
    ...
    void print_deck()
    {
        ...
        Log.e("Deck", "Values are :"+toprint);
    }

    void print_open_cards()
    {
        String toprint = "";
        for(int i=0; i<open_cards.size(); i++)
        {
        ...
        Log.e("Open Cards", "Values are :"+toprint);
    }
